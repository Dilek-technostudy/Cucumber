...
//td[contains(text(), '"+expectedname+"')]/..//ms-delete-button")
//td[contains(text(),'Cucucitizen')]//following-sibling::td//ms-delete-button/button
//td[contains(text(), 'Cucucitizen')]/..//ms-delete-button